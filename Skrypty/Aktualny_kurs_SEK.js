...
fetch('https://api.nbp.pl/api/exchangerates/rates/A/SEK/')
    ...
    .then(data => {
        ...
        let sek30 = 350;
        let wynik30 = sek30 * rate;
        document.getElementById('SEK30').innerHTML = wynik30.toFixed(2) + 'zł';
        let sek31 = 220;
        let wynik31 = sek31 * rate;
        document.getElementById('SEK31').innerHTML = wynik31.toFixed(2) + 'zł';
        let sek32 = 455;
        let wynik32 = sek32 * rate;
        document.getElementById('SEK32').innerHTML = wynik32.toFixed(2) + 'zł';
        let sek33 = 290;
        let wynik33 = sek33 * rate;
        document.getElementById('SEK33').innerHTML = wynik33.toFixed(2) + 'zł';
        let sek34 = 39;
        let wynik34 = sek34 * rate;
        document.getElementById('SEK34').innerHTML = wynik34.toFixed(2) + 'zł';
        let sek35 = 27;
        let wynik35 = sek35 * rate;
        document.getElementById('SEK35').innerHTML = wynik35.toFixed(2) + 'zł';
        let sek36 = 81;
        let wynik36 = sek36 * rate;
        document.getElementById('SEK36').innerHTML = wynik36.toFixed(2) + 'zł';
        let sek37 = 53;
        let wynik37 = sek37 * rate;
        document.getElementById('SEK37').innerHTML = wynik37.toFixed(2) + 'zł';
