...
.then(data => {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        if (deszcz < 15){
            ...
            poziom_deszczu +='bardzo lekki deszcz.png'
        }
        else if(deszcz < 24){
            // poziom_deszczu +='<b>Lekki deszcz</b>'
            poziom_deszczu +='lekki deszcz.png'
        }
        else if (deszcz < 96){
            // poziom_deszczu +='<b>Umiarkowany deszcz</b>'
            poziom_deszczu +='umiarkowany deszcz.png'
        }
        else if (deszcz < 288){
            // poziom_deszczu +='<b>Ulewa</b>'
            poziom_deszczu +='ulewny1.png'
        }
        else{
            // poziom_deszczu +='<b>Nawałnica</b>'
            poziom_deszczu +='nawałnica.png'
        }
